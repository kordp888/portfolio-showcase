...
<img src="images/dasion5060.png" alt="다시ON5060 Production 홈의 음성 질문과 생활 과제 화면" width="320">

디지털 환경이 낯선 사용자가 말로 질문하면 지금 해야 할 행동 한 단계만 안내하는
한국어 음성 우선 생활 도우미입니다. 사진 보내기와 글씨 크게 보기처럼 자주 막히는 생활 과제를
앞으로 뺐습니다.

[웹앱 사용하기](https://dasion-app.vercel.app) · [GitHub 보기](https://github.com/kordp888/dasi-on5060)

2026-09-13 실제 Production 홈에서 캡처했습니다. 홈의 HTTP 응답과 화면을 확인한 기록이며,
고령 사용자 사용성 결과나 실기기 음성 검사를 뜻하지 않습니다.

### AI Career Insight Coach · 쓰기 전에 발견하기

<img src="images/career-insight-coach.png" alt="합성 경험 두 개를 실제 AI로 분석한 Career Coach Production 인사이트 화면" width="900">

산업과 기업, 직무를 분석하고 여러 경험에서 찾은 인사이트를 직접 선택한 뒤
이력서·자기소개서·포트폴리오를 만듭니다. 자기소개서는 설계안을 먼저 확인하고 초안을 요청합니다.
생성된 문장은 직접 수정하고 복사할 수 있습니다.

[웹앱 사용하기](https://career-insight-coach.vercel.app) · [GitHub 보기](https://github.com/kordp888/career-insight-coach)

실제 AI 분석이 가능한 웹앱입니다. 지원 전 결과를 사용자가 직접 확인하고 수정하도록 설계했습니다.
입력은 브라우저에 저장되며, AI 분석을 요청하면 서버로 전송됩니다. 민감한 개인정보는 넣지 마세요.

2026-09-13 Production에서 합성 경험 두 개로 분석부터 문서 세 종류 생성까지 확인했습니다.
위 이미지는 예시 모드가 아닌 실제 AI 응답 화면입니다. 합격률이나 사용자 성과는 검증하지 않았습니다.
검사 범위는 [검증 기록](VERIFICATION.md)에 남겼습니다.
