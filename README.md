...
매장의 부족 인원을 확인하고 후보 비교, 제안, 모의 수락과 준비 확인, 관리자 확정까지 이어지는 교육용 인터랙티브 프로토타입입니다. 관리자 화면 3개와 근로자 응답 모의화면을 연결했습니다.

[프로토타입 열기](https://wesop-shopsol-prototype.vercel.app/)

<img src="images/wesop.png" alt="가상 매장의 부족 인원을 보여주는 ShopSol FLEX 프로토타입" width="420">

2026-09-09 보관 검증 기록: 단위·빌드 검사 58개, 공개 HTTPS 브라우저 검사 278개 통과. 서로 다른 실행의 검사 수를 합산하지 않습니다. 실제 참여자 0명으로 사용자 가설은 NOT_RUN입니다. 실기기 검사와 현장 채용 성과도 미검증입니다. 합성 데이터만 사용하며 실제 샵솔 연동·채용·AI 추천은 수행하지 않습니다. 제품 구현 저장소는 비공개입니다.
