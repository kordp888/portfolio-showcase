...
<img src="images/career-insight-coach.png" alt="AI Career Insight Coach 소개 인포그래픽" width="560">

자소서를 대신 써주는 AI는 이미 많습니다. 그렇게 나온 문장은 서로 닮아 가고, 지원자가 실제로 내린
판단은 빠집니다. 그래서 순서를 바꿨습니다. 산업과 기업, 직무를 먼저 이해하고, 자기 경험에서 그
직무와 이어지는 인사이트를 찾은 다음에 이력서와 자기소개서로 넘어갑니다.

[저장소 보기](https://github.com/kordp888/career-insight-coach)

공개 저장소에는 제품 개요와 경험 정리 템플릿, 가상 지원자 예시만 있습니다. 이미지 속 화면은
콘셉트 시안입니다.
